                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="vendor_billing_city" value="<?php if(isset($vendor)){ echo $vendor['vendor_billing_city']; } ?>" name="vendor_billing_city" maxlength="128" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
