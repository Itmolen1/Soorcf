            ...
            <ul class="sidebar-menu" data-widget="tree">
               ...
               <?php 
                  ...
                  if(isset($alldata['role']) || $alldata['role']!=1)
                  {
                     ...
                     //echo "<pre>";print_r($modulestodisplay);
                     if(isset($this->session->userdata['myfinal']['amc_listing']['p_view']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_view']==1 ||
                        isset($this->session->userdata['myfinal']['amc_listing']['p_add']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_add']==1 ||
                        isset($this->session->userdata['myfinal']['amc_listing']['p_update']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_update']==1 ||
                        isset($this->session->userdata['myfinal']['amc_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_delete']==1 || 
                        isset($this->session->userdata['myfinal']['amc_content_listing']['p_view']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_view']==1 || 
                        isset($this->session->userdata['myfinal']['amc_content_listing']['p_add']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_add']==1 ||  
                        isset($this->session->userdata['myfinal']['amc_content_listing']['p_update']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_update']==1 || 
                        isset($this->session->userdata['myfinal']['amc_content_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_delete']==1 ||
                        $this->session->userdata['role']==1)
                     {
                        
                     ?>
                     <li class="<?php if($flag==7){ echo 'treeview active menu-open'; } else echo 'treeview'; ?>" style="height: auto;">
                        <a href="#">
                        <i class="fa fa-files-o"></i> <span>AMC</span>
                        <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                        </span>
                        </a>
                        <ul class="treeview-menu">
                           <?php if(isset($this->session->userdata['myfinal']['amc_listing']['p_add']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_add']==1 ||
                        isset($this->session->userdata['myfinal']['amc_listing']['p_update']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_update']==1 ||
                        isset($this->session->userdata['myfinal']['amc_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['amc_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>

                           <li><a href="<?php echo base_url(); ?>amc_listing"><i class="fa fa-shopping-cart"></i>AMCs</a></li>

                           <?php } if(isset($this->session->userdata['myfinal']['amc_content_listing']['p_add']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_add']==1 ||
                        isset($this->session->userdata['myfinal']['amc_content_listing']['p_update']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_update']==1 ||
                        isset($this->session->userdata['myfinal']['amc_content_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['amc_content_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>
                           
                           <li><a href="<?php echo base_url(); ?>amc_content_listing"><i class="fa-credit-card"></i>AMC Content</a></li>                              
