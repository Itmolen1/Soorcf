                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="add_new_item_unit" action="<?php echo base_url().$action?>" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <textarea class="ckeditor input" id="item_master_desc_long" name="item_master_desc_long"><?php echo isset($list['item_master_desc_long']) ? $list['item_master_desc_long'] : ""; ?></textarea>
                            </div>
