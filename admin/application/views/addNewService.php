                                ...
                                <div class="col-md-6">                                
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo isset($servicesInfo->detail_page) ? $servicesInfo->detail_page : ""; ?>" id="detail_page" name="detail_page" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))">
                                    </div>
