...
class User_api extends CI_Controller {
	...
	public function Ravi()
	{
    	...
    	if(!empty($header['X-Api-Key']) && $header['X-Api-Key']=='wahidfix')
		{
			$registrationIds ='eHUk-UzXPO4:APA91bFKyEWog-3kvK1oLSvZFh53fx-_SzTHFsZuyAqC6NTohEuBZsP3Y2hIltfrGGor-KzOV3R3j8Kg9Jd9feUYV60Y9Tm9bsEzIAC7nSZvXSTe6fa7BqQhcYsQCGAEse4AhmLydVTA';
			$msg = array
			(
