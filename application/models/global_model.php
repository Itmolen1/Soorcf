...
class global_model extends CI_Model {
	...
	{
		$this->db->select('item_master_id,item_master_url_slug,item_master_name,item_master_desc,item_master_desc_long,item_master_price,item_master_logo,item_master_unit');
