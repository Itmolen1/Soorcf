        ...
        <div class="container">
                    ...
                    <div class="contact_form">
                        ...
                        ?>
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="email" name="partner_email" id="partner_email" class="form-control" placeholder="Your Email" maxlength="40" required onKeyDown="if(event.keyCode === 32) return false;">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-md-offset-1 col-sm-10 col-md-10 col-sm-offset-1 pd-add">
                    <div class="address-item col-sm-3 col-md-3 col-sm-offset-1">
                        <div class="address-icon">
                            <i class="icon icon-location2"></i>
                        </div>
                        <h3 class="about-text" style="word-wrap: break-word;">Headquarters</h3>
                        <p class="about-text" style="word-wrap: break-word;">MUSSAFAH M13,PLOT 100 
                            <br>ABU DHABI,UAE</p>
                    </div>
                    <div class="address-item col-sm-3 col-md-3 col-sm-offset-1 about-item">
                        <div class="address-icon">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                        </div>
                        <h3 class="about-text" style="word-wrap: break-word;">Email Us</h3>
                        <p class="about-text" style="word-wrap: break-word;">info@wahidfix.com</p>
                    </div>
                    <div class="address-item col-sm-3 col-md-3 col-sm-offset-1 about-item">
                        <div class="address-icon">
                            <i class="icon icon-headphones"></i>
                        </div>
                        <h3 class="about-text" style="word-wrap: break-word;">Call Us</h3>
                        <p class="about-text" style="word-wrap: break-word;">+12 345 6789</p>
                    </div>
                </div>
            </div><!-- end row -->
