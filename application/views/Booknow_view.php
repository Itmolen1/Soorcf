                               ...
                               <?php 
                                ...
                                <?php } else {  ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <input type="email" name="tbl_guest_user_email" id="tbl_guest_user_email" class="form-control" placeholder="Your Email" required="required" maxlength="40" onKeyDown="if(event.keyCode === 32) return false;">
                                    </div>
