                    ...
                    <div class="contact_form">
                        ...
                        ?>
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="email" name="careers_email" id="careers_email" class="form-control" placeholder="Your Email" maxlength="40" required onKeyDown="if(event.keyCode === 32) return false;">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
